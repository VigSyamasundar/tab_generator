...
# prints an error message and quits the script if the error severity is high enough
...
# COMMENTS - 
# reason for serial alignment failure is because if max entry diff is zero () but character size of serial is > 1, can be misleading
